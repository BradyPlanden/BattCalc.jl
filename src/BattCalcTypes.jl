...
@with_kw mutable struct Cathode
    Name = "NCM811"
    Formula = "0.833Li:0.8Ni:0.08Co:0.08Mn:0.04Al:2O"
    Porousity = (0.335±0.0122)u"cm^3/cm^3"
    CoatingThickness = (72.5±1.45)u"μm"
    CollectorThickness = (16±0.32)u"μm"
    Area = (0.0±0.0)u"cm^2"
...
@with_kw mutable struct ElectrolyteStruct
    ...
    ρₑ = (0.0±0.0)u"g/cm^3"
    VolumeRatio = (1.6±0.032)u"g/A*hr"
    Mass = (0±0.0)u"g"
end
